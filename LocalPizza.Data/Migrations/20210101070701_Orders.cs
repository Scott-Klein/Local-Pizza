        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveredTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemTopping", x => new { x.OrderItemsId, x.ToppingsId });
                    table.ForeignKey(
                        name: "FK_OrderItemTopping_OrderItems_OrderItemsId",
                        column: x => x.OrderItemsId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItemTopping_Toppings_ToppingsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemTopping_ToppingsId",
